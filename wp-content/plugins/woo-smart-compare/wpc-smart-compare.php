...
! defined( 'WOOSC_VERSION' ) && define( 'WOOSC_VERSION', '4.3.2' );
		...
		if ( ! class_exists( 'WPCleverWoosc' ) && class_exists( 'WC_Product' ) ) {
			class WPCleverWoosc {
				...
				function __construct() {
					...
					// add to compare
					add_action( 'template_redirect', array( $this, 'woosc_add_by_link' ) );
				...
				function woosc_init() {
					...
					$button_archive = apply_filters( 'woosc_button_position_archive', get_option( 'woosc_button_archive', apply_filters( 'woosc_button_position_archive_default', 'after_add_to_cart' ) ) );

					if ( ! empty( $button_archive ) ) {
						switch ( $button_archive ) {
							...
							case 'after_add_to_cart':
								...
								break;
							default:
								add_action( 'woosc_button_position_archive_' . $button_archive, array(
									$this,
									'woosc_add_button'
								) );
						}
					...
					$button_single = apply_filters( 'woosc_button_position_single', get_option( 'woosc_button_single', apply_filters( 'woosc_button_position_single_default', '31' ) ) );

					if ( ! empty( $button_single ) ) {
						if ( is_numeric( $button_single ) ) {
							add_action( 'woocommerce_single_product_summary', array(
								$this,
								'woosc_add_button'
							), (int) $button_single );
						} else {
							add_action( 'woosc_button_position_single_' . $button_single, array(
								$this,
								'woosc_add_button'
							) );
						}
                                ...
                                <form method="post" action="options.php">
                                    ...
                                    <table class="form-table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
												<?php
												$button_archive    = apply_filters( 'woosc_button_position_archive', 'default' );
												$positions_archive = apply_filters( 'woosc_button_positions_archive', array(
                                                ...
                                                <select name="woosc_button_archive" <?php echo( $button_archive !== 'default' ? 'disabled' : '' ); ?>>
													<?php
													if ( $button_archive === 'default' ) {
														$button_archive = get_option( 'woosc_button_archive', apply_filters( 'woosc_button_position_archive_default', 'after_add_to_cart' ) );
													}

													foreach ( $positions_archive as $k => $p ) {
														echo '<option value="' . esc_attr( $k ) . '" ' . ( ( $k === $button_archive ) || ( empty( $button_archive ) && empty( $k ) ) ? 'selected' : '' ) . '>' . esc_html( $p ) . '</option>';
													}
													?>
                                                </select>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
												<?php
												$button_single    = apply_filters( 'woosc_button_position_single', 'default' );
												$positions_single = apply_filters( 'woosc_button_positions_single', array(
                                                ...
                                                <select name="woosc_button_single" <?php echo( $button_single !== 'default' ? 'disabled' : '' ); ?>>
													<?php
													if ( $button_single === 'default' ) {
														$button_single = get_option( 'woosc_button_single', apply_filters( 'woosc_button_position_single_default', '31' ) );
													}

													foreach ( $positions_single as $k => $p ) {
														echo '<option value="' . esc_attr( $k ) . '" ' . ( ( $k === $button_single ) || ( empty( $button_single ) && empty( $k ) ) ? 'selected' : '' ) . '>' . esc_html( $p ) . '</option>';
													}
													?>
                                                </select>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="woosc_table_settings">
                                                    <option
                                                            value="yes" <?php echo( get_option( 'woosc_table_settings', 'yes' ) === 'yes' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'Yes', 'woo-smart-compare' ); ?>
                                                    </option>
                                                    <option
                                                            value="no" <?php echo( get_option( 'woosc_table_settings', 'yes' ) === 'no' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'No', 'woo-smart-compare' ); ?>
                                                    </option>
                                                </select>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="woosc_remove">
                                                    <option
                                                            value="yes" <?php echo( get_option( 'woosc_remove', 'yes' ) === 'yes' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'Yes', 'woo-smart-compare' ); ?>
                                                    </option>
                                                    <option
                                                            value="no" <?php echo( get_option( 'woosc_remove', 'yes' ) === 'no' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'No', 'woo-smart-compare' ); ?>
                                                    </option>
                                                </select>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="woosc_bar_settings">
                                                    <option
                                                            value="yes" <?php echo( get_option( 'woosc_bar_settings', 'no' ) === 'yes' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'Yes', 'woo-smart-compare' ); ?>
                                                    </option>
                                                    <option
                                                            value="no" <?php echo( get_option( 'woosc_bar_settings', 'no' ) === 'no' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'No', 'woo-smart-compare' ); ?>
                                                    </option>
                                                </select>
                                                <span class="description"><?php esc_html_e( 'Show the settings popup to customize fields (show/ hide / rearrange).', 'woo-smart-compare' ); ?></span>
                                ...
                                <form method="post" action="options.php">
                                    ...
                                    <table class="form-table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="regular-text"
                                                       ...
                                                       value="<?php echo esc_attr( self::woosc_localization( 'table_remove' ) ); ?>"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="regular-text"
                                                       ...
                                                       value="<?php echo esc_attr( self::woosc_localization( 'table_settings' ) ); ?>"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="regular-text"
                                                       ...
                                                       value="<?php echo esc_attr( self::woosc_localization( 'hide_similarities' ) ); ?>"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="regular-text"
                                                       ...
                                                       value="<?php echo esc_attr( self::woosc_localization( 'highlight_differences' ) ); ?>"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="regular-text"
                                                       name="woosc_localization[bar_settings]"
                                                       value="<?php echo esc_attr( self::woosc_localization( 'bar_settings' ) ); ?>"
                                                       placeholder="<?php esc_attr_e( 'Settings', 'woo-smart-compare' ); ?>"/>
                                            </td>
                                        </tr>
                                        <tr>
				...
				function woosc_get_table( $ajax = true ) {
					...
					if ( is_array( $woosc_products ) && ( count( $woosc_products ) > 0 ) ) {
						...
						$remove = get_option( 'woosc_remove', 'yes' );
						...
						foreach ( $woosc_products as $woosc_product ) {
							...
							if ( $remove === 'yes' ) {
								$woosc_products_data[ $woosc_product ]['name'] .= ' <span class="woosc-remove" data-id="' . $woosc_product . '">' . self::woosc_localization( 'table_remove', esc_html__( 'remove', 'woo-smart-compare' ) ) . '</span>';
							}
						...
						$woosc_table .= '<table ' . ( $ajax ? 'id="woosc_table"' : '' ) . ' class="' . esc_attr( $woosc_table_class ) . '"><thead><tr>';

						// settings
						if ( get_option( 'woosc_table_settings', 'yes' ) === 'yes' ) {
							$woosc_table .= '<th><a href="javascript:void(0);" class="woosc-table-settings">' . self::woosc_localization( 'table_settings', esc_html__( 'Settings', 'woo-smart-compare' ) ) . '</a></th>';
						} else {
							$woosc_table .= '<th></th>';
						}
						...
						foreach ( $saved_fields as $saved_field ) {
							...
							if ( ! in_array( $saved_field, array(
								...
								$woosc_field .= '<tr class="tr-default tr-' . ( $tr % 2 ? 'odd' : 'even' ) . ' tr-' . esc_attr( $saved_field ) . ' ' . ( ! in_array( $saved_field, $cookie_fields ) ? 'tr-hide' : '' ) . '"><td class="td-label">' . esc_html( self::$woosc_fields[ $saved_field ] ) . '</td>';
				...
				function woosc_add_by_link() {
					...
					$woosc_cookie  = 'woosc_products_' . md5( 'woosc' . $user_id );
					$user_products = isset( $_COOKIE[ $woosc_cookie ] ) ? explode( ',', $_COOKIE[ $woosc_cookie ] ) : array();
					...
					setcookie( $woosc_cookie, implode( ',', $user_products ), time() + 604800, '/' );

					// redirect to wishlist page
					wp_safe_redirect( self::woosc_get_page_url() );
				}
				...
				function woosc_shortcode( $attrs ) {
					$output = '';
				...
				function woosc_shortcode_list( $attrs ) {
					return '<div class="woosc_list woosc-list woosc_page woosc-page">' . $this->woosc_get_table( false ) . '</div>';
				}
				...
				function woosc_wp_footer() {
					...
					if ( get_option( 'woosc_bar_settings', 'no' ) === 'yes' || get_option( 'woosc_table_settings', 'yes' ) === 'yes' ) { ?>
                                    ...
                                    <div class="woosc-popup-content-inner">
                                        ...
                                        <ul class="woosc-settings-tools">
                                            <li><label><input type="checkbox"
                                                              ...
                                                              id="woosc_hide_similarities"/> <?php echo self::woosc_localization( 'hide_similarities', esc_html__( 'Hide similarities', 'woo-smart-compare' ) ); ?>
                                                </label></li>
                                            <li><label><input type="checkbox"
                                                              class="woosc-settings-tool"
                                                              id="woosc_highlight_differences"/> <?php echo self::woosc_localization( 'highlight_differences', esc_html__( 'Highlight differences', 'woo-smart-compare' ) ); ?>
                                                </label></li>
                                        </ul>
                    ...
                    <div id="woosc-area" class="<?php echo esc_attr( $woosc_class ); ?>"
                        ...
                        <div class="woosc-inner">
                            ...
                            <div class="woosc-bar <?php echo esc_attr( get_option( 'woosc_bar_bubble', 'no' ) === 'yes' ? 'woosc-bar-bubble' : '' ); ?>">
								...
								if ( get_option( 'woosc_bar_settings', 'no' ) === 'yes' ) { ?>
                                    <a href="javascript:void(0);" class="woosc-bar-settings hint--top"
                                       aria-label="<?php echo esc_attr( self::woosc_localization( 'bar_settings', esc_html__( 'Settings', 'woo-smart-compare' ) ) ); ?>"></a>
								<?php }
				...
				public static function woosc_get_count() {
					...
					if ( isset( $_POST['woosc_products'] ) && ( $_POST['woosc_products'] !== '' ) ) {
						$woosc_products = explode( ',', (string) $_POST['woosc_products'] );
					} else {
						$woosc_cookie = 'woosc_products_' . md5( 'woosc' . get_current_user_id() );
