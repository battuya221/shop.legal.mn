...
! defined( 'WOOSQ_VERSION' ) && define( 'WOOSQ_VERSION', '2.8.5' );
		...
		if ( ! class_exists( 'WPCleverWoosq' ) ) {
			class WPCleverWoosq {
				...
				function __construct() {
					...
					// summary
					add_action( 'woosq_product_summary', array( $this, 'woosq_before_title' ), 4 );
					add_action( 'woosq_product_summary', 'woocommerce_template_single_title', 5 );
					add_action( 'woosq_product_summary', array( $this, 'woosq_after_title' ), 6 );

					add_action( 'woosq_product_summary', array( $this, 'woosq_before_rating' ), 9 );
					add_action( 'woosq_product_summary', 'woocommerce_template_single_rating', 10 );
					add_action( 'woosq_product_summary', array( $this, 'woosq_after_rating' ), 11 );

					add_action( 'woosq_product_summary', array( $this, 'woosq_before_price' ), 14 );
					add_action( 'woosq_product_summary', 'woocommerce_template_single_price', 15 );
					add_action( 'woosq_product_summary', array( $this, 'woosq_after_price' ), 16 );

					add_action( 'woosq_product_summary', array( $this, 'woosq_before_excerpt' ), 19 );
					add_action( 'woosq_product_summary', 'woocommerce_template_single_excerpt', 20 );
					add_action( 'woosq_product_summary', array( $this, 'woosq_after_excerpt' ), 21 );

					add_action( 'woosq_product_summary', array( $this, 'woosq_add_to_cart' ), 25 );

					add_action( 'woosq_product_summary', array( $this, 'woosq_before_meta' ), 29 );
					add_action( 'woosq_product_summary', 'woocommerce_template_single_meta', 30 );
					add_action( 'woosq_product_summary', array( $this, 'woosq_after_meta' ), 31 );
					...
					if ( ! empty( $position ) ) {
						switch ( $position ) {
							...
							case 'after_add_to_cart':
								...
								break;
							default:
								add_action( 'woosq_button_position_' . $position, array( $this, 'woosq_add_button' ) );
						}
					}
				}
				...
				function woosq_add_to_cart( $product ) {
					do_action( 'woosq_before_add_to_cart' );
					...
					do_action( 'woosq_after_add_to_cart' );
				}
				...
				function woosq_shortcode( $attrs ) {
					$output = '';
					...
					if ( $attrs['id'] ) {
						...
						if ( $attrs['type'] === 'link' ) {
							$output = '<a href="#" class="' . esc_attr( $button_class ) . '" data-id="' . esc_attr( $attrs['id'] ) . '" data-effect="' . esc_attr( $attrs['effect'] ) . '" data-context="' . esc_attr( $attrs['context'] ) . '">' . esc_html( $button_text ) . '</a>';
						} else {
				...
				function woosq_before_title() {
					do_action( 'woosq_before_title' );
				}

				function woosq_after_title() {
					do_action( 'woosq_after_title' );
				}

				function woosq_before_rating() {
					do_action( 'woosq_before_rating' );
				}

				function woosq_after_rating() {
					do_action( 'woosq_after_rating' );
				}

				function woosq_before_price() {
					do_action( 'woosq_before_price' );
				}

				function woosq_after_price() {
					do_action( 'woosq_after_price' );
				}

				function woosq_before_excerpt() {
					do_action( 'woosq_before_excerpt' );
				}

				function woosq_after_excerpt() {
					do_action( 'woosq_after_excerpt' );
				}

				function woosq_before_meta() {
					do_action( 'woosq_before_meta' );
				}

				function woosq_after_meta() {
					do_action( 'woosq_after_meta' );
				}
